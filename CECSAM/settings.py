"""
Django settings for CECSAM project.
...
TEMPLATE_CONTEXT_PREPROCESSORS = ("django.contrib.auth.context_processors.auth",
...
ROOT_URLCONF = 'CECSAM.urls'

WSGI_APPLICATION = 'CECSAM.wsgi.application'
